 ...
 * @author Lucas
 */
public class LisataQuarto extends javax.swing.JFrame {

    /**
     * Creates new form LisataQuarto
     */
    public LisataQuarto() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LisataQuarto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LisataQuarto().setVisible(true);
            }
        });
    }
