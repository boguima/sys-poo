...
public class ListaQuarto extends javax.swing.JFrame {
     ...
     */
    public ListaQuarto() throws RepositoryException {
        initComponents();
        
          DefaultTableModel mod = (DefaultTableModel)jTable1.getModel();
        
        
        for (Quarto quarto : new QuartoService().findAll()) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            for (Iterator<Quarto> it = new QuartoRepository().findAll().iterator(); it.hasNext();) {
            ...
            Logger.getLogger(ListaQuarto.class.getName()).log(Level.SEVERE, null, ex);
        }
