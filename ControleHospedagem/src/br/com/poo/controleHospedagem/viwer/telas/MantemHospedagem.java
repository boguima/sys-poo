...
public class MantemHospedagem extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btFecharContaHospedagem = new javax.swing.JButton();
        ...
        paramDataEntarda.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("yyyy-MM-dd"))));
                    ...
                    if (validaCamposObrigatorios()) {
                        ...
                        if (quartoAux != null) {
                            if (!quartoAux.getId().equals(this.hospedagem.getQuarto().getId())) {
                                quartoAux.setSituacao("0");
                                (new QuartoService()).update(quartoAux);
                            }
                        }
    ...
    private void refreshScreen() {
        ...
        setLimparViwerDadosCliente();
        this.quarto = new Quarto();
        setLimparViwerDadosQuarto();
        this.hospedagem = new Hospedagens();
        setLimparViwerDadosHospedagem();
        btLocalizarQuarto.setEnabled(false);
        btCadastrar.setEnabled(false);
        btExcluir.setEnabled(false);
        btFecharContaHospedagem.setEnabled(false);
